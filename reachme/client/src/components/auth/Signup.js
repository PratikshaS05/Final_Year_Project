...
export default function Signup() {
    ...
    const registerUser = async () => {
        await axios.post('/signup', { name, email, password, profilePhoto: url, strength:strength})
            .then(res => {
                            ...
                            <div className="card-body">
                                ...
                                {password}
                                    <div className='input-group'>
                                        ...
                                        e.target.value.length>8 && (/[a-z]/.test(e.target.value)) && (/[A-Z]/.test(e.target.value)) && (/[0-9]/.test(e.target.value))?setStrength("Strong"):setStrength("Weak");
                                    ...
                                    <small className="form-text text-muted">
                                        minimum 8 characters long. ({strength})
                                </small>
                                </div>
                                ...
                                <div className='text-center mt-5'>
                                    <p className="btn btn-primary text-center px-3 disabled" onClick={() => postData()}>
                                        Register
                                </p>
                                </div>
                            </div>

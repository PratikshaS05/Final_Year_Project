...
router.post('/signup', async (req, res) => {
    const { name, email, password, profilePhoto, strength } = req.body
                ...
                .then((hashedPassword) => {
                    ...
                    user.save()
                        .then(() => {
                            ...
                            const mymail = {
                                to: user.email,
                                from: 'suryawanshipratiksha05@gmail.com',
                                subject: 'signup successful',
                                html: "<h1>Welcome to ReachMe !!!</h1>"
                            }
                            console.log(mymail)
                ...
                user.save()
                    .then(() => {
                        const mymail = {
                            to: user.email,
                            from: 'suryawanshipratiksha05@gmail.com',
                            subject: 'reset password link for your account on reachme',
                            html: `
